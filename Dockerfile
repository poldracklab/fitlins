...
# Timestamp: 2019-04-29 15:28:46 UTC
# 
...
RUN echo "$VERSION" > /src/fitlins/fitlins/VERSION && echo include fitlins/VERSION >> /src/fitlins/MANIFEST.in
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run", \
    \n      "echo \"$VERSION\" > /src/fitlins/fitlins/VERSION && echo include fitlins/VERSION >> /src/fitlins/MANIFEST.in" \
    \n    ], \
    \n    [ \
    \n      "run", \
